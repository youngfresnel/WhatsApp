...
import {ITabHeaderProps} from './type'
...
import FastImage from "react-native-fast-image";
 ...
 export const ChatHead = React.memo((props:any) => {
    const appColor = useAppcolor();
    return(
        <View key={Math.floor(Math.random()*9999999999999).toString()} style={{flexDirection:'row', alignContent:'center', marginBottom:scale(20)}}>
            <View>
               <Image
               resizeMode="cover"
            ...
            <View style={{flexGrow:1, marginLeft:scale(10)}}>
                ...
                <WText style={{color:appColor.text_color_2, fontSize:textScale(13), fontWeight:200}} fontFamily='roman'> Yo man on dit quoi le full stack </WText>
            </View>
            <View style={{}}>
                <WText style={{color:appColor.text_color_2}} fontFamily='light'>15/00/0000</WText>
            </View>
        </View>
    )
})
