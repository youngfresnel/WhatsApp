 ...
 export const TabsHeaderComponent = React.memo((props:ITabHeaderProps)=>{
    ...
    return(
        <View style={[styles.headerstyle, {backgroundColor:appColor.dark_blue_10}]}>
            <WText style={[{fontSize:textScale(28)},props.bolder && {color:appColor.green_100, fontFamily:fonts.bold}]}>WhatsApp</WText>
            <View style={styles.headerIconContainer}>
                {props.icons.map((icon:any) => <View onTouchEnd={() => icon.onPress()} key={Math.floor(Math.random()* 99999).toString()} style={{width:scale(24), height:scale(24), marginRight:scale(10),marginLeft:scale(10)}}>{icon.icon}</View>)}
            </View>
        </View>
    )
});
